...
//#define ASTAR_SET_LEVELGRIDNODE_HEIGHT //@SHOWINEDITOR Enables a field height for each node if you want to use that information. Not used by any included scripts. Warning: Will break node serialization if changed.
//#define ASTAR_LEVELGRIDNODE_FEW_LAYERS //@SHOWINEDITOR Reduces the max number of layers for LayeredGridGraphs from 255 to 16. Saves memory.
